...
function CookiesPolicy() {
    return(
        ...
        <ul>
        <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to lorenz-rockstuhl.de.</li>
        <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
        <li><strong>Website</strong> refers to lorenz-rockstuhl.de, accessible from <a href="lorenz-rockstuhl.de" rel="external nofollow noopener" target="_blank">lorenz-rockstuhl.de</a></li>
        ...
        <li>
        <p>By visiting this page on our website: <a href="lorenz-rockstuhl.de" rel="external nofollow noopener" target="_blank">lorenz-rockstuhl.de</a></p>
        </li>
        </ul>
        </>
    )
